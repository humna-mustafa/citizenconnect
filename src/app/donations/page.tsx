      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            <div className="w-24 h-24 bg-white/10 backdrop-blur-xl rounded-full flex items-center justify-center mx-auto mb-8 border border-white/20 shadow-2xl shadow-blue-900/50">
              <Heart className="w-12 h-12 text-blue-400" />
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight">Make a Difference</h1>
            <p className="text-xl text-blue-100/80 mb-10 leading-relaxed">
              Support verified causes and help those in need. <br className="hidden md:block" />
            ...
            <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto">
              {[
                ...
                { value: 'Zero', label: 'Platform Fees' },
              ].map((stat, index) => (
