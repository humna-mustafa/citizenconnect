    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <section className="relative py-20 overflow-hidden bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900">
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(at_40%_20%,_rgba(59,130,246,0.15)_0px,_transparent_50%)]"></div>
          <div className="absolute inset-0 bg-[radial-gradient(at_80%_0%,_rgba(99,102,241,0.1)_0px,_transparent_50%)]"></div>
        </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center text-white">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/5 backdrop-blur-md rounded-full text-sm font-semibold mb-8 border border-white/10 shadow-lg">
              <Heart className="w-4 h-4 text-emerald-500" />
              <span className="text-emerald-400">100% Transparent Donations</span>
            </div>
            <h1 className="text-5xl md:text-6xl font-bold mb-6 tracking-tight text-white">Support a Cause</h1>
