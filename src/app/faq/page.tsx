        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-100 rounded-full text-sm font-semibold mb-8 border border-emerald-200">
              ...
              <span className="text-emerald-700">Help Center</span>
            </div>
            ...
            <div className="max-w-xl mx-auto">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 rounded-2xl bg-white text-slate-900 placeholder:text-slate-400 shadow-xl focus:ring-2 focus:ring-emerald-500 outline-none border border-gray-100"
                />
              </div>
            </div>
          </div>
